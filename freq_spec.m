...
% FREQ_SPEC(signal,samping_rate),   signal is the signal whose spectrum is to 
% be plotted and sampling_rate is number of samples taken
% sampling rate must be almost 5 to 10 times the frequency for accurate
% x-axis
